...
<body>
    ...
    <form action="query-string" method="get">
        ...
        <input type="checkbox" name="hobbies" id="music" value="label"/><label for="music">음악</label>
    ...
    <form action="post-request" method="post">
        ...
        <input type="checkbox" name="hobbies" id="music2" value="label"/><label for="music2">음악</label>
