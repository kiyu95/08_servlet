package com.ohgiraffers.section02.formdate;
...
public class FormDataTestServlet extends HttpServlet {
    ...
    * setCharactorEncoding(String encType)으로 지정해주어야 브라우저에서 요청한 인코딩 방식과 일치하여 한글 깨짐 현상을 막을 수 있다.
    * */
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {

        // 기본설정 인코딩 방식이 null이므로 톰캣의 기본 세팅 값이 ISO-8859-1로 디코딩을 시도한다.
