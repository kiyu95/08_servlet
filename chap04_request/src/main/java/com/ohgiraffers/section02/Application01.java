...
public class Application01 {
    public static void main(String[] args) throws IOException {
        ...
        while ((client = serverSocket.accept()) != null){
            Socket finalCilent = client;
            new Thread(() -> {
                try {
                    BufferedReader reader = new BufferedReader(new InputStreamReader(finalCilent.getInputStream()));
                    ...
                    if ("POST".equals(requestMethod)){
                        int contentLength = Integer.parseInt(requestHeader.get("Content-Lenghth"));
